...
figures = workflow.plot_default_diagnostics(
    test_data=300,
    loss_kwargs={"figsize": (15, 15), "label_fontsize": 12},
    recovery_kwargs={"figsize": (15, 15), "label_fontsize": 12},
    calibration_ecdf_kwargs={"figsize": (15, 15), "legend_fontsize": 8, "label_fontsize": 12},
    coverage_kwargs={"figsize": (15, 15), "legend_fontsize": 8, "label_fontsize": 12},
    z_score_contraction_kwargs={"figsize": (15, 15), "label_fontsize": 12}
)
plt.savefig("default_diagnostics.pdf")
